...
<div class="row">
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card mb-3 widget-content bg-arielle-smile">
            <div class="widget-content-wrapper text-white">
                ...
                <div class="widget-content-right">
                    <div class="widget-numbers text-white"><span>{{ $categorycount }}</span></div>
                </div>
            </div>
        </div>
    </div> 
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card mb-3 widget-content bg-grow-early">
            <div class="widget-content-wrapper text-white">
                <div class="widget-content-left">
                    <div class="widget-heading">Total Item</div>
                </div>
                <div class="widget-content-right">
                    <div class="widget-numbers text-white"><span>{{ $itemcount }}</span></div>
                </div>
            </div>
        </div>
    </div> 
     ...
     <div class="col-md-6 col-xl-3">
        <div class="card mb-3 widget-content bg-midnight-bloom">
            <div class="widget-content-wrapper text-white">
                <div class="widget-content-left">
                    <div class="widget-heading">Total Slider</div>
                </div>
                <div class="widget-content-right">
                    <div class="widget-numbers text-white"><span>{{ $slidercount }}</span></div>
                </div>
            </div>
        </div>
    </div> 
 ...
 <div class="col-md-6 col-xl-3">
        <div class="card mb-3 widget-content bg-arielle-smile">
            <div class="widget-content-wrapper text-white">
                ...
                <div class="widget-content-right">
                    <div class="widget-numbers text-white"><span>{{ $reservationcount }}</span></div>
                </div>
            </div>
        </div>
    </div> 
